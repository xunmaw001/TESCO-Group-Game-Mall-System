          ...
          <el-form-item class="input" label="开发商" prop="kaifashang">
              <el-input v-model="ruleForm.kaifashang" 
                placeholder="开发商" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="上市日期" prop="shangshiriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.shangshiriqi" 
                type="date"
                placeholder="上市日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangshiriqi" label="上市日期" prop="shangshiriqi">
              <el-input v-model="ruleForm.shangshiriqi" 
                placeholder="上市日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxijianjie = true;
            continue;
          }
	            	            if(o=='shangshiriqi'){
            this.ruleForm.shangshiriqi = obj[o];
	    this.ro.shangshiriqi = true;
            continue;
          }
	                    }
                                                                                                                              }
	...
	this.ruleForm.youxijianjie = this.ruleForm.youxijianjie.replace(reg,'../../../ssmoafa5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangchengyouxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangchengyouxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
