          ...
          <el-form-item class="input" label="游戏分类" prop="youxifenlei">
              <el-input v-model="ruleForm.youxifenlei" 
                placeholder="游戏分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开发商" prop="kaifashang">
          <el-input v-model="ruleForm.kaifashang" 
              placeholder="开发商" clearable  :readonly="ro.kaifashang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开发商" prop="kaifashang">
              <el-input v-model="ruleForm.kaifashang" 
                placeholder="开发商" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="购买日期" prop="goumairiqi">
              <el-input v-model="ruleForm.goumairiqi" 
                placeholder="购买日期" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="游戏软件" prop="youxiruanjian">
          <file-upload
          tip="点击上传游戏软件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.youxiruanjian?ruleForm.youxiruanjian:''"
          @change="youxiruanjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.youxiruanjian" label="游戏软件" prop="youxiruanjian">
            <el-button type="text" size="small" @click="download(ruleForm.youxiruanjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxifenlei = true;
            continue;
	            	            ...
	            	            if(o=='kaifashang'){
            this.ruleForm.kaifashang = obj[o];
	    this.ro.kaifashang = true;
            continue;
          }
	            	            if(o=='goumairiqi'){
	    ...
	    this.ro.goumairiqi = true;
            continue;
	            	            ...
	            	            if(o=='youxiruanjian'){
            this.ruleForm.youxiruanjian = obj[o];
	    this.ro.youxiruanjian = true;
            continue;
          }
	            	            if(o=='yonghuming'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `youxixiazai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.youxixiazaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                    ...
                                                                                    youxiruanjianUploadChange(fileUrls) {
                this.ruleForm.youxiruanjian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
